...
from .find_best_model import ImprovedLSTMPredictorMultiOutput, ModelFinder
...
class StockPredictor(StockModelTrain):
    ...
    def analyze_stock_advanced(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Calculer le score
            self.trading_score = self.calculate_trading_score()
...
def main():
    ...
    try:
        ...
        predictor = StockPredictor(symbol, period="6mo")
